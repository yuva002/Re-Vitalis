...
export default function PricingCards({ variant = "default" }: { variant?: PricingVariant }) {
  ...
  return (
    <section id="membership" className="w-full py-24 px-6">
      ...
      {/* ── Cards grid ── */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-[1100px] mx-auto">
        ...
        >
          ...
          <div className={[
            ...
            <div className="mb-5 flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold tracking-tight text-neutral-900">Classic Care</h2>
                <p className="text-neutral-600 text-sm leading-relaxed mt-1">3-month wellness foundation.</p>
              </div>
        ...
        >
          ...
          <div className={[
            ...
            <div className="mb-5 flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-bold tracking-tight text-neutral-50">Elite Care</h2>
                <p className="text-neutral-400 text-sm leading-relaxed mt-1">6-month transformation plan.</p>
              </div>
          ...
          <div className={[
            ...
            <div className="mb-5 flex items-center justify-between">
              <div>
                ...
                <p className="text-[#8B6E47] text-sm leading-relaxed mt-1">12-month full VIP experience.</p>
              </div>
